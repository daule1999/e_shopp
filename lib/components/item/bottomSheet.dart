...
class ShowBottomScreen extends StatelessWidget {
  ...
  void createIconList() {
    ...
    iconList.add({
      'name': 'Save to drive',
      'iconName': FontAwesomeIcons.googleDrive,
    ...
    iconList.add({
      'name': 'Telegram',
      'iconName': FontAwesomeIcons.telegram,
            ...
            slivers: <Widget>[
              SliverGrid(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      mainAxisSpacing: 26.0, crossAxisCount: 4),
