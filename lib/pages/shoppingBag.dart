...
import '../components/shoppingBag/shoppingBagExpandedList.dart';
...
class _ShoppingBagState extends State<ShoppingBag> {
  ...
  void removeItem(item, context) async {
    ...
    if (connectionStatus) {
      bagItemList
          .removeWhere((items) => items['productId'] == item['productId']);
              ...
              child: Column(
                children: <Widget>[
                  ExpandablePanel(
                    ...
                    expanded: ShoppingBagExpandedList(item, colorList,
                        openParticularItem, removeItemAlertBox),
                    collapsed: null,
                  ),
                ],
              ),
