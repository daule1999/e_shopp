...
class _SubCategoryState extends State<SubCategory> {
  ...
  listSubCategoryItems(String subCategoryId, String subCategoryName,
    ...
    if (connectionStatus) {
      ...
      List<Map<String, String>> items =
          await _productService.listSubCategoryItems(subCategoryId);
      Navigator.of(_keyLoader.currentContext, rootNavigator: true).pop();
      Navigator.pushNamed(context, '/items',
          arguments: {'items': items, 'heading': subCategoryName});
    } else {
                  ...
                  Expanded(
                    ...
                    child: InkWell(
                      ...
                      child: GridTile(
                        ...
                        // ),
                        child: Image.asset(
                          "assets/mock_images/category/$imagePath",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
